      ...
      <nav className="flex items-center">
        ...
        <div className="ml-auto 2xl:mr-20 3xl:mr-48">
          <ul className="flex gap-10 xl:gap-20 2xl:gap-24 3xl:gap-28">
            <li className={`font-bold uppercase cursor-pointer hover:scale-125 transition-all`}>
              <Link to="/">Home</Link>
            </li>
            <li
            ...
            <div className="relative">
             <Link to="/cart"><i className="fa-solid fa-cart-shopping cursor-pointer text-lg text-gray-500 hover:scale-125 transition-all"></i></Link> 
