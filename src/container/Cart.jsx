      ...
      <main className="flex justify-center items-center mt-8">
        <div className="relative ">
          ...
          <div className="bg-white w-[50rem] h-[45rem] border border-black box-shadow filter drop-shadow-2xl flex  items-center justify-center rounded-xl">
            <div className="w-[90%] h-[90%] border-8 border-lightYellow rounded-md relative flex flex-col  items-center gap-4">
              ...
              <div className="bg-lightYellow w-[40%] flex items-center justify-center px-2 absolute left-[14.5rem] -bottom-5 cursor-pointer hover:scale-110 transition-all">
